...
import com.twilio.voice.quickstart.dialog.Dialog;
import com.twilio.video.AudioTrack;
import com.twilio.video.CameraCapturer;
...
public class VideoActivity extends AppCompatActivity {
     ...
     */
    private static final String TWILIO_ACCESS_TOKEN = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiIsImN0eSI6InR3aWxpby1mcGE7dj0xIn0..gT_aMVPjmVkyD_xyBbD2bWkiBhajipgcm_7XZAxTPec";
...
soid application UI elements
    ...
    private void createLocalMedia() {
        ...
        // Share your camera
        cameraCapturer = new CameraCapturer(this, CameraCapturer.CameraSource.FRONT_CAMERA, null);
    ...
    private void createVideoClient() {
        ...
        videoClient = new VideoClient(VideoActivity.this, accessManager.getToken());
        ...
        return new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (localVideoTrack != null) {
                    ...
                    int icon;
                    if (enable) {
                        icon = R.drawable.common_google_signin_btn_icon_dark_normal;
                        switchCameraActionFab.show();
                    } else {
                        icon = R.drawable.common_google_signin_btn_icon_dark_disabled;
